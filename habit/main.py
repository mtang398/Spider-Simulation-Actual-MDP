...
def getEnvironmentPolicies(directory):
    ...
    environmentPolicies = [[[] for vision in range(NumVisualRange)] for simulation in range(NumSimulations)]
    ...
    for simulationInd in range(NumSimulations):
        for visrange in range(NumVisualRange):
            ...
            #episodeFolder = parentDirectory + '/planning/Data/Simulation_%d/Vision_%d/Depth_2000/*.csv'%(simulationInd, visrange+1)
            episodeFolder = 'C:/Users/terra/project/Data/Simulation_%d/VisualRange_%d\Depth_2000\episode_*.csv'%(simulationInd, visrange+1)
...
def getPredatorLocations(directory):
    ...
    for simulationInd in range(NumSimulations):
        episodeFolder = 'C:/Users/terra/project/Data/Simulation_%d/VisualRange_1/Depth_2000/episode_*.csv'%(simulationInd)
        episodeFiles = glob.glob(episodeFolder)
...
if __name__ == "__main__":
    ...
    print('\r' + "Starting habit simulations")
